...
contains
  ...
  function hernquistConstructorParameters(parameters) result(self)
    ...
    <inputParameter>
      <name>mass</name>
      <defaultValue>1.0d0</defaultValue>
      <description>The total mass (in $M_\odot$) of the Hernquist profile, used to set the density normalization when \mono{densityNormalization} is not supplied directly.</description>
      <source>parameters</source>
    </inputParameter>
    <inputParameter>
