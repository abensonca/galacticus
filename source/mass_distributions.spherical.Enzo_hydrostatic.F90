...
contains
  ...
  function enzoHydrostaticConstructorParameters(parameters) result(self)
    ...
    <inputParameter>
      <name>mass</name>
      <description>The total mass (in $M_\odot$) of the hot gas distribution enclosed within \mono{radiusOuter}; used to normalize the Enzo hydrostatic density profile.</description>
      <source>parameters</source>
    </inputParameter>
    <inputParameter>
