...
!!}
  ...
  <galacticFilter name="galacticFilterTreeHosted">
   <description>Passes only nodes that are currently hosted in a merger tree, filtering out any isolated or unhosted nodes that may exist outside the tree structure.</description>
  </galacticFilter>
  !!]
