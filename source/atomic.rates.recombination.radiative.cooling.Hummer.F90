...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  <enumeration>
   <name>sequence</name>
   <description>Enumeration of isoelectronic sequences (atoms/ions with the same number of electrons) used to select the appropriate tabulated recombination cooling data from Hummer (1994): hydrogen-like, helium-like, or no sequence.</description>
   <indexing>0</indexing>
   <entry label="none"    />
  ...
  <enumeration>
   <name>level</name>
   <description>Enumeration of recombination level cases used in the Hummer (1994) tables: level 1 includes recombinations to all levels (Case A), while level B excludes direct recombinations to the ground state (Case B).</description>
   <indexing>1</indexing>
   <entry label="1"/>
   <entry label="B"/>
  </enumeration>
