...
contains
  ...
  function massDistributionZhao1996ConstructorParameters(parameters) result(self)
    ...
    <inputParameter>
      <name>mass</name>
      <defaultValue>1.0d0</defaultValue>
      <description>The total mass (in $M_\odot$) of the \cite{zhao_analytical_1996} profile, used to set the density normalization $\rho_0$ when \mono{densityNormalization} is not supplied directly.</description>
      <source>parameters</source>
    </inputParameter>
    <inputParameter>
