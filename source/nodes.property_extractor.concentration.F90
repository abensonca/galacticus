...
!!}
  ...
  <nodePropertyExtractor name="nodePropertyExtractorConcentration">
   <description>A property extractor that returns the concentration parameter $c = r_\mathrm{vir}/r_s$
    of the dark-matter-only halo profile, where $r_\mathrm{vir}$ is defined by the supplied
    \refClass{virialDensityContrastClass} object and $r_s$ is the NFW scale radius from the
