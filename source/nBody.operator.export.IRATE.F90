...
!!}
  ...
  <nbodyOperator name="nbodyOperatorExportIRATE">
   <description>An N-body data operator which exports N-body simulation data to the IRATE (Interface for Reduction of Astronomical Theory and Experiment) HDF5 format for interoperability with other analysis tools. The output file path is set by \mono{[fileName]}, with the snapshot index and redshift specified by \mono{[snapshot]} and \mono{[redshift]}.</description>
  </nbodyOperator>
  !!]
