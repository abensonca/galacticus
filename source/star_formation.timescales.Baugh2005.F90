...
contains
  ...
  function baugh2005ConstructorParameters(parameters) result(self)
    ...
    <inputParameter>
      ...
      <description>The normalization velocity $V_0$ (in km/s) appearing in the \cite{baugh_can_2005} star formation timescale relation $\tau_\star = \tau_0 (V_\mathrm{disk}/V_0)^\alpha a^\beta$, with a default value of 200 km/s.</description>
      <source>parameters</source>
    </inputParameter>
