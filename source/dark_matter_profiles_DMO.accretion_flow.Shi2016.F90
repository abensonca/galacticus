...
contains
  ...
  function accretionFlowShi2016ConstructorParameters(parameters) result(self)
    ...
    <inputParameter>
      ...
      <description>A dimensionless multiplicative scale factor applied to the inflow velocities computed from the Shi (2016) splashback and accretion flow model, allowing calibration of the infall velocity amplitude relative to the theoretical prediction.</description>
    </inputParameter>
