...
contains
  ...
  function cuspNFWConstructorParameters(parameters) result(self)
    ...
    <inputParameter>
      <name>mass</name>
      <defaultValue>1.0d0</defaultValue>
      <description>The total mass (in $M_\odot$) of the cusp-NFW halo, used to set the density normalization when the concentration and virial radius are provided instead of \mono{densityNormalization}.</description>
      <source>parameters</source>
    </inputParameter>
    <inputParameter>
