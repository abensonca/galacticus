...
module Display
  ...
  <enumeration>
   ...
   <description>Enumeration of verbosity levels for controlling the amount of output displayed during a Galacticus run, ranging from \mono{silent} (no output) through \mono{standard}, \mono{working}, \mono{warn}, and \mono{info} to \mono{debug} (maximum diagnostic output).</description>
