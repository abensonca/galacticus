...
!!}
  ...
  <surveyGeometry name="surveyGeometryLocalGroupDES">
   <description>Implements the angular footprint and maximum detection distance of the Dark Energy Survey (DES) as applied to Local Group dwarf galaxy searches. The survey volume is defined by Mangle polygon files, with the maximum survey distance set by \mono{[distanceMaximumSurvey]}.</description>
  </surveyGeometry>
  !!]
