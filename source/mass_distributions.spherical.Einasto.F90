...
contains
  ...
  function massDistributionEinastoConstructorParameters(parameters) result(self)
    ...
    <inputParameter>
      <name>mass</name>
      <defaultValue>1.0d0</defaultValue>
      <description>The total mass (in $M_\odot$) of the Einasto profile, used to set the density normalization $\rho_{-2}$ when \mono{densityNormalization} is not supplied.</description>
      <source>parameters</source>
    </inputParameter>
    <inputParameter>
