...
module Dark_Matter_Profiles_Concentration
  ...
  <functionClass>
   ...
   <description>
    Class providing the concentration parameter $c = r_\mathrm{vir}/r_\mathrm{s}$ of dark matter halo density profiles,
    where $r_\mathrm{vir}$ is the virial radius and $r_\mathrm{s}$ is the characteristic scale radius. The concentration
    encodes the inner density structure of a halo and depends on halo mass and formation history. Implementations provide
    both the instantaneous concentration and the mean concentration--mass relation, along with definitions of the density
    contrast and dark matter profile used in computing the concentration.
   </description>
