...
module HII_Region_Density_Distributions
  ...
  <functionClass>
   ...
   <description>
    ...
    \gls{hii} regions — the probability distribution of gas density within the photoionized nebula.
    ...
    of real \gls{hii} regions, which affects nebular line luminosities and the ionizing photon budget.
   </description>
