...
!!}
  ...
  <darkMatterParticle name="darkMatterParticleCDM">
   <description>Provides a cold dark matter particle with effectively infinite mass and negligible free-streaming length, representing the standard collisionless CDM model in which structure grows hierarchically from small scales upward.</description>
  </darkMatterParticle>
  !!]
