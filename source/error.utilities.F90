...
module Error_Utilities
  ...
  <enumeration>
    <name>signal</name>
    <description>Enumeration of POSIX signal numbers (SIGHUP through SIGSYS) used to identify which signal should trigger a graceful pause or abort of the simulation when caught by the error handler.</description>
